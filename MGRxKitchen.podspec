...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/magic_harly@hotmail.com/MGRxKitchen'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'magic_harly@hotmail.com' => 'magic_harly@hotmail.com' }
  s.source           = { :git => 'https://github.com/magic_harly@hotmail.com/MGRxKitchen.git', :tag => s.version.to_s }
